        ...
        children: [
          ...
          Row(
            children: [
              ...
              IconButton(key: const Key('addRoommateButton'),
                  icon: const Icon(Icons.add), onPressed: _addRoommate),
            ],
          ),
          ...
          Row(
            children: [
              ...
              IconButton(key: const Key('addCategoryButton'),
                  icon: const Icon(Icons.add), onPressed: _addCategory),
            ],
          ),
        ],
      ),
